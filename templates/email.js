const htmlMsg = (email,password, link) => {
    return `
                      ...
                      >
                        <div style="width: 100% !important">
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                <p
                                  ...
                                  "
                                >
                                  <span style="font-size: 42px">Votre compte est activé!</span>
                                </p>
                              </div>
                            </div>
                            ...
                            >
                              ...
                              >
                                <p
                                  ...
                                  "
                                >
                                  <span style="font-size: 18px">J’espère que ce mail vous trouvera bien! !</span>
                                </p>
                                <p
                                  style="
                                    font-size: 14px;
                                ...
                                >
                                  <span style="font-size: 18px"
                                    >Nous venons de vous créer un compte sur Artisanat,</span
                                  >
                                </p>
                                <p
                                  style="
                                ...
                                <p
                                  ...
                                  "
                                >
                                  <span style="font-size: 18px">Voici vos identifiants de compte:</span>
                                </p>
                                <p
                                  style="
                                    font-size: 14px;
                                ...
                                >
                                  ...
                                  <span style="font-size: 18px">mot de passe: ${password}</span>
                                </p>
                              </div>
                            </div>
                            <!--[if mso]></td></tr></table><![endif]-->
                            ...
                            >
                              <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-top: 10px; padding-right: 10px; padding-bottom: 10px; padding-left: 10px" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:31.5pt; width:125.25pt; v-text-anchor:middle;" arcsize="10%" stroke="false" fillcolor="#3AAEE0"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#ffffff; font-family:Tahoma, sans-serif; font-size:16px"><!
                              [endif]--><a
                                href="${link}"
                                style="
                                      ...
                                      <tbody>
                                        ...
                                        >
                                          <td
                                            ...
                                            valign="top"
                                          >
                                            <a href="https://www.facebook.com/fivepacademy" target="_blank"
                                              ><img
                                                alt="Facebook"
                                                height="32"
                                                src="https://imgur.com/8yJCzkt.png"
                                                style="
                                                  text-decoration: none;
                                          ...
                                          <td
                                            ...
                                            valign="top"
                                          >
                                            <a href="https://www.instagram.com/fivepoints.tn/" target="_blank"
                                              ><img
                                                alt="Instagram"
                                                height="32"
                                                src="https://imgur.com/vjPm1wp.png"
                                                style="
                                                  text-decoration: none;
                                                  -ms-interpolation-mode: bicubic;
                                                  height: auto;
                                          ...
                                          >
                                            <a
                                              href="https://www.linkedin.com/company/fivepoints-the-talent-pool/"
                                              target="_blank"
                                              ><img
                                                alt="LinkedIn"
                                                height="32"
                                                src="https://imgur.com/UhZbPNR.png"
                                                style="
                                                  text-decoration: none;
                                                  -ms-interpolation-mode: bicubic;
                                                  height: auto;
